...
def test_weights_all_steps(simulation_station_capacity2):
...
def test_weights_stations_only(simulation_station_capacity2):
...
def test_weights_set_for_one_train(simulation_station_capacity2):
    w = weights.all_steps(simulation_station_capacity2)
    w.weights.train(0, 2)
    expected = pd.DataFrame(
        {
...
def test_weights_set_for_one_step(simulation_station_capacity2):
    w = weights.all_steps(simulation_station_capacity2)
...
def test_weights_set_for_one_train_at_a_station(simulation_station_capacity2):
    w = weights.all_steps(simulation_station_capacity2)
