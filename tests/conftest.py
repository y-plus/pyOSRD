...
def osrd_cvg_dvg_missing_sim() -> Generator[OSRD, None, None]:
    yield OSRD(
        dir="tmp",
...
@pytest.fixture(scope='session')
def osrd_cvg_dvg_before_run() -> Generator[OSRD, None, None]:
    yield OSRD(dir="tmp5", results_json="missing.json")
    shutil.rmtree('tmp5', ignore_errors=True)


@pytest.fixture(scope='session')
def simulation_cvg_dvg() -> Generator[OSRD, None, None]:
    yield OSRD(dir='tmp', simulation='cvg_dvg')
    shutil.rmtree('tmp', ignore_errors=True)


@pytest.fixture(scope='session')
def simulation_station_builder() -> Generator[OSRD, None, None]:
    yield OSRD(
...
def modify_sim() -> Generator[OSRD, None, None]:
    yield OSRD(dir='tmp', simulation='cvg_dvg')
    shutil.rmtree('tmp', ignore_errors=True)


@pytest.fixture(scope='session')
def simulation_station_capacity2() -> Generator[OSRD, None, None]:
    yield OSRD(dir='tmp', simulation='station_capacity2')
    shutil.rmtree('tmp', ignore_errors=True)


@pytest.fixture(scope='session')
def simulation_point_switch() -> Generator[OSRD, None, None]:
    yield OSRD(dir='tmp', simulation='point_switch')
    shutil.rmtree('tmp', ignore_errors=True)


@pytest.fixture(scope='session')
def simulation_straight_line() -> Generator[OSRD, None, None]:
    yield OSRD(dir='tmp', simulation='straight_line')
    shutil.rmtree('tmp', ignore_errors=True)


@pytest.fixture(scope='session')
def simulation_double_switch() -> Generator[OSRD, None, None]:
    yield OSRD(dir='tmp', simulation='double_switch')
    shutil.rmtree('tmp', ignore_errors=True)


@pytest.fixture(scope='session')
def infra_crossing() -> Generator[OSRD, None, None]:
...
@pytest.fixture(scope='session')
def infra_double_slip() -> Generator[OSRD, None, None]:
...
@pytest.fixture(scope='session')
def infra_point_switch() -> Generator[OSRD, None, None]:
...
@pytest.fixture(scope='session')
def infra_station_c2() -> Generator[OSRD, None, None]:
