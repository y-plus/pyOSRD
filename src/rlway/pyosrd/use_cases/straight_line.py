...
def straight_line(
    ...
    stationB.add_part(track=T, offset=5_000)
    stationC = infra_builder.add_operational_point(label='stationC')
    stationC.add_part(track=T, offset=10_000-460)
    ...
    train1 = sim_builder.add_train_schedule(
        ...
        label='First train',
        departure_time=0,
        stops=[Stop(location=B, duration=120)],
    ...
    # train2.add_stop(120., location=B)
