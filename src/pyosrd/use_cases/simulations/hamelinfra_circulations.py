...
def hamelinfra_circulations(
    ...
    for i in range(n_hours):
        ...
        sim_builder.add_train_schedule(
            ...
            departure_time=build_departure_time(cur_hour,
                                                15 if i % 2 == 0 else 10),
            rolling_stock='hamelin_rolling_stock',
            stops=[
                Stop(120, station_location(infra, 'I', 'V3', 0)),
        ...
        sim_builder.add_train_schedule(
            ...
            departure_time=build_departure_time(cur_hour, 16),
            rolling_stock='hamelin_rolling_stock',
            stops=[
                Stop(120, station_location(infra, 'G', 'V5', 0)),
                Stop(180, station_location(infra, 'F', 'V5', 75)),
        ...
        sim_builder.add_train_schedule(
            ...
            departure_time=build_departure_time(cur_hour, 37),
            rolling_stock='hamelin_rolling_stock',
            stops=[
                Stop(120, station_location(infra, 'D', 'V2', 0)),
                Stop(120, station_location(infra, 'E', 'V4', 75)),
        ...
        sim_builder.add_train_schedule(
            ...
            departure_time=build_departure_time(cur_hour, 35),
            rolling_stock='hamelin_rolling_stock',
            stops=[
                Stop(120, station_location(infra, 'K', 'V4', 0)),
                Stop(120, station_location(infra, 'J', 'V1', -75)),
        ...
        if i % 2 == 0:
            sim_builder.add_train_schedule(
                ...
                departure_time=build_departure_time(cur_hour, 9),
                rolling_stock='hamelin_rolling_stock',
                stops=[
                    Stop(120, station_location(infra, 'A', 'V2', 0)),
                    Stop(120, station_location(infra, 'K', 'V2', -50)),
            ...
            sim_builder.add_train_schedule(
                ...
                departure_time=build_departure_time(cur_hour+1, 9),
                rolling_stock='hamelin_rolling_stock',
                stops=[
