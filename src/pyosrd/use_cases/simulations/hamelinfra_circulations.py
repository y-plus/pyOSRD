...
def hamelinfra_circulations(
    ...
    for i in range(n_hours):
        ...
        sim_builder.add_train_schedule(
            ...
            station_location(infra, 'E', 'V1', 75),
            station_location(infra, 'F', 'V1', 75),
            station_location(infra, 'G', 'V1', 75),
            ...
            stops=[
                Stop(120, station_location(infra, 'D', 'V1', 0)),
                Stop(120, station_location(infra, 'I', 'V4', 0)),
            ]
        ...
        sim_builder.add_train_schedule(
            ...
            station_location(infra, 'E', 'V1', -75),
            station_location(infra, 'D', 'V1', 75),
            ...
            stops=[
                ...
                Stop(120, station_location(infra, 'D', 'V1', -50)),
            ]
        ).add_standard_single_value_allowance("percentage", 5, )

        sim_builder.add_train_schedule(
            station_location(infra, 'D', 'V3'),
            station_location(infra, 'E', 'V1', 75),
            station_location(infra, 'F', 'V1', 75),
            station_location(infra, 'G', 'V1', 75),
            ...
            rolling_stock='hamelin_rolling_stock',
            stops=[
                Stop(120, station_location(infra, 'D', 'V3', 0)),
